...
test('getDocumentBaseUrl', function() {
	...
	equal(getDocumentBaseUrl({protocol: 'http:', host: '192.168.43.252', pathname: '/dir/path1/path2'}), 'http://192.168.43.252/dir/path1/');
	equal(getDocumentBaseUrl({protocol: 'https:', host: '192.168.43.252', pathname: '/dir/path1/path2'}), 'https://192.168.43.252/dir/path1/');
	equal(getDocumentBaseUrl({protocol: 'https:', host: '192.168.43.252', pathname: '/dir/path1/path2/'}), 'https://192.168.43.252/dir/path1/path2/');
	equal(getDocumentBaseUrl({protocol: 'http:', host: '192.168.43.252:8080', pathname: '/dir/path1/path2'}), 'http://192.168.43.252:8080/dir/path1/');
	equal(getDocumentBaseUrl({protocol: 'http:', host: '192.168.43.252', pathname: '/dir/path1/path2/file.html'}), 'http://192.168.43.252/dir/path1/path2/');
	equal(getDocumentBaseUrl({protocol: 'http:', host: '192.168.43.252', pathname: '/'}), 'http://192.168.43.252/');
