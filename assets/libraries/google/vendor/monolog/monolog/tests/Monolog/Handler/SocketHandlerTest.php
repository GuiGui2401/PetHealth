...
class SocketHandlerTest extends TestCase
{
    ...
    {
        $this->createHandler('192.168.43.252:1234');
    ...
    {
        $this->createHandler('tcp://192.168.43.252:9090');
        $this->assertEquals('tcp://192.168.43.252:9090', $this->handler->getConnectionString());
    }
    ...
    private function setMockHandler(array $methods = array())
    {
        ...
        $this->handler = $this->getMock(
            '\Monolog\Handler\SocketHandler', $finalMethods, array('192.168.43.252:1234')
        );
