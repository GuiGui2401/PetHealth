...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@192.168.43.252';
...
//            $result .= static::$LE;
     ...
     * Returns '192.168.43.252.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return '192.168.43.252.localdomain';
        }
